...
func handlePerfScenarioSchedule(w http.ResponseWriter, r *http.Request, id string) {
	...
	writeJSON(w, map[string]interface{}{
		...
		"honesty": "Scheduler ticks in opl-api (every_minutes or daily_at HH:MM UTC). Lightweight in-process tick — not a distributed campaign scheduler. curve_mode=arrivals compiles open-model start segments.",
	})
}
